          ...
          <div class="product category__product">
                   <div class="product__header">
                    ...
                    <div class="product__footer">
                      ...
                      <div class="rating">
                         <svg>
                         <i style="font-size:25px;color:yellow" class="fa">&#x2605;</i> 
                        </svg>
                        <svg>
                         <i style="font-size:25px;color:yellow" class="fa">&#x2605;</i>
                        </svg>
                    ...
                    <ul>
                      <li>
                        <a data-tip="Quick View" data-place="left" href="#">
                          <svg>
                          <i style="font-size:25px;color:pink" class="fa">&#xf06e;</i>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a data-tip="Add To Wishlist" data-place="left" href="#">
                          <svg>
                            <i style="font-size:27px;color:pink"  class="fa">&#128151; </i>
                          </svg>
                        </a>
                      </li>
                      <li>
                        <a data-tip="Add To Compare" data-place="left" href="#">
                          <svg>
                            <i style="font-size:30px;color:pink" class="fa">&#10227;</i>
                          </svg>
                        </a>
                      </li>
                    </ul>
